...
Output:
- data/clean/ssl_stimuli_final_unannot.csv: Selected stimuli for SSL experiments
"""
...
OUTPUT_PATH = "../data/clean/ssl_stimuli_final_unannot.csv"
...
def print_summary_stats(df, stimuli_dict):
    ...
    log_and_print("\nCrosstabs of agreement and domain")
    crosstab = pd.crosstab(df['ssl_domain'], df['agreement_category'])
    log_and_print(crosstab)
